...
{
    /// <summary>
    /// Generic variant of NetNode3D that supports typed network input.
    ...
    /// <example>
    /// <code>
    /// public struct PlayerShipInput
    /// {
    ///     public bool ThrustForward, ThrustReverse, ThrustLeft, ThrustRight;
    ///     public bool ThrustUp, ThrustDown;
    ///     public bool LookLeft, LookRight, LookUp, LookDown;
    ///     public bool LandOrBoard;
    /// }
    /// 
    /// public partial class PlayerShip : NetNode3D&lt;PlayerShipInput&gt;
    /// {
    ///     public override void _Process(double delta)
    ///     {
    ///         SetInput(new PlayerShipInput {
    ///             ThrustForward = Input.IsActionPressed("ship_thrust_forward"),
    ///             // ... etc
    ///         });
    ///     }
    /// }
    /// </code>
    /// </example>
    public partial class NetNode3D<TInput> : NetNode3D, INetInputNode
