...
namespace Nebula
{
	...
	*/
    ...
    public partial class NetNode2D : Node2D, INetNode<NetNode2D>, INotifyPropertyChanged
    {
        ...
        /// Override is generated by the source generator for classes with [NetProperty(Predicted = true)].
        /// </summary>
        internal virtual void RestoreToConfirmedState() { }
        ...
        /// Override is generated by the source generator for classes with [NetProperty(Predicted = true)].
        /// </summary>
        internal virtual void RestoreMispredictedToConfirmed() { }
        ...
        /// Returns true if all predicted properties are within tolerance.
        /// Override is generated by the source generator for classes with [NetProperty(Predicted = true)].
        /// </summary>
        internal virtual bool CompareAllPredictedState(int tick) => true;

        /// <summary>
        /// Smooths render values toward simulation values. Called every frame.
        /// Override is generated by the source generator for classes with [NetProperty(Predicted = true)].
        /// </summary>
        internal virtual void ProcessPredictionSmoothing(float delta) { }
        ...
        void INetNodeBase.RestoreToConfirmedState() => RestoreToConfirmedState();
        void INetNodeBase.RestoreMispredictedToConfirmed() => RestoreMispredictedToConfirmed();
        void INetNodeBase.RestoreToPredictedState(int tick) => RestoreToPredictedState(tick);
        bool INetNodeBase.CompareAllPredictedState(int tick) => CompareAllPredictedState(tick);
        void INetNodeBase.ProcessPredictionSmoothing(float delta) => ProcessPredictionSmoothing(delta);
        #endregion
